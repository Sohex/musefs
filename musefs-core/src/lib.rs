...
//! ([`scan_directory_with`]), the virtual tree of re-tagged paths ([`VirtualTree`]),
...
pub use tree::{
    InodeAllocator, METRICS_DIR_NAME, Node, NodeKind, RESERVED_ROOT_NAMES, SPOTLIGHT_MARKER_NAME,
    VirtualTree,
};
