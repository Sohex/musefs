...
| SP4 | Implemented | `SP4-storage-aware-serving.md` | `../../plans/2026-06-01-sp4-storage-aware-serving.md` | `max_readahead`/async-read/parallel-dirops in `init` + Ogg first-read index mitigation. Read benches held (see `BENCHMARKS.md` "SP4 — Storage-aware serving"). |
...
- **SP3 — Read/serve residuals** (2026-06-01, same box · tempfs · Criterion `ci`
  ...
  FUSE e2e `all_supported_formats_decode_to_same_pcm_sha_as_source` +
